#!/usr/bin/env python3
"""Mirror the site's typefaces from Google Fonts into the repository.
...
API = ("https://fonts.googleapis.com/css2"
       ...
       # Lexend and Manrope set the Blog's front page, and nothing else on
       # the site. A face is only fetched by a browser that renders it, so
       # declaring them here costs the other pages nothing.
       "&family=Lexend:wght@500;600;700"
       "&family=Manrope:wght@400;600&display=swap")
...
def main():
    ...
    header = (
        "/* ============================================================\n"
        "   The site's typefaces, served from this repository.\n"
        "   ------------------------------------------------------------\n"
